...
export const notableExperiences: Experience[] = [
    {
        ...
        org: 'WSD',
        startYear: 2023,
        descriptions: ['Translating the needs of clients at major investment banks into code for the automated generation of financial documents for trading structured products.'],
    ...
    },
    {
        ...
        startYear: 2022,
        endYear: 2023,
        descriptions: ['Learned full-stack development through 30 technically self-guided projects. Improved lesson content and more in a popular, open source full-stack web development curriculum by making pull requests to its GitHub repo: github.com/TheOdinProject/curriculum'],
...
export const educationalExperiences: Experience[] = [
    {
        ...
        startYear: 2017,
        endYear: 2022,
        descriptions: ['Featured a year-long master\'s project in computer vision entailing training a CNN for multi-output regression upon microscopic images.'],
